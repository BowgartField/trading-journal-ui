...
import { PROVIDER, ChainId } from './consts';
...
// Running in server OR no Metamask
  ...
  // Create our own provider. The default blockchain is Avalanche
  const newProvider = new Web3.providers.HttpProvider(PROVIDER[ChainId.AVALANCHE])
